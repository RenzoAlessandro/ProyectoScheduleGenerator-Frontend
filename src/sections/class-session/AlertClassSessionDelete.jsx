...
export default function AlertClassSessionDelete({ id, classSessionId, open, handleClose }) {
  const deletehandler = async () => {
    // await deleteClassSession(id).then(() => {
    //   openSnackbar({
    //     open: true,
...
AlertClassSessionDelete.propTypes = { id: PropTypes.number, classSessionId: PropTypes.string, open: PropTypes.bool, handleClose: PropTypes.func };
